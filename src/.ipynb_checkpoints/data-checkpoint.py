...
def consolidate_dataset():
    ...
    df_product['product_category_name'] = df_product['product_category_name'].map(pd.Series(df_product_category_translation['product_category_name_english'].values,
    ...
    df_order = df_order.merge(df_states, how='left', left_on='customer_state', right_on='state_code', suffixes=('','_customer'))
